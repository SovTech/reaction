...
/**
 * @name Query/discountedItems
 * @method
 * @memberof Catalog/GraphQL
 * @summary Get a list of discountedItems
 ...
 */
export default async function discountedItems(_, args, context, info) {
  ...
  const query = await context.queries.discountedItems(context, {
    catalogBooleanFilters,
    shopIds,
    tagIds
  });
